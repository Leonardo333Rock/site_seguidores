...
const valores = ['15,90','24,90','37,90','49,90','64,90','88,90']
const quantidades = ['500','1.000','2.000','3.000','5.000','10.000']
...
for(let x=0; x<6; x++){
    ...
    p1.innerHTML=`${quantidades[x]} CURTIDAS`
...
btn_comprar.map((e) => {
    e.addEventListener('click', (e) => {
        mensagem = ""
        mensagem  = 'Olá quero comprar ' + e.target.parentNode.parentNode.children[0].children[0].innerHTML + " no Kwai"
        if (isMobile) {
